...
//this is connected with the joe's object
// 2. What is "this" when joe.scopeArrow() is invoked?
//connected to the window (global)
// 3. Explain why "this" is different when an arrow function is used.
//from what i understood which is nothing much that when arrow function is used  this refers to it’s current surrounding scope and no further